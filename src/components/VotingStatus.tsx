...
export const VotingStatus: React.FC<VotingStatusProps> = ({ 
    ...
    return (
      <div className={`bg-gray-50 border border-gray-200 rounded-lg p-4 ${className}`}>
        <div className="flex items-center gap-2 text-gray-500">
          ...
          <span>Memuat status voting...</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className={`border rounded-lg p-4 ${getStatusBgColor()} ${className}`}>
        ...
        <div className="mt-4 pt-3 border-t border-gray-200">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
            <div>
              ...
              <div className="text-gray-600">{votingStatus.settings.voting_name}</div>
            </div>
            <div>
